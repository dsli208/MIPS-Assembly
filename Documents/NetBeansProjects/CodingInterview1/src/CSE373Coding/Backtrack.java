...
public class Backtrack {
    ...
    // Check to see if the current solution vector is a potential solution
    private boolean isASolution(int solutionVector[], int currentIndex, int input[]) {
        // If we have filled in (input.length) elements into solution vector then we have a solution
